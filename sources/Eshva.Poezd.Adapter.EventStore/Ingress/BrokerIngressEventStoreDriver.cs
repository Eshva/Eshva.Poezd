...
{
  public class BrokerIngressEventStoreDriver : IBrokerIngressDriver
  {
    public BrokerIngressEventStoreDriver(
      BrokerIngressEventStoreDriverConfiguration driverConfiguration,
    ...
    private static readonly MethodInfo CreateAndRegisterStreamSubscriptionsMethod =
      typeof(BrokerIngressEventStoreDriver).GetMethod(
